...
window.dash_clientside.gallery = {
    ...
    open_gallery_modal: function (n_clicks_list, gallery_data) {
        ...
        for (let i = 0; i < gallery_data.length; i++) {
            if (gallery_data[i].id === clicked_id) {
                new_index = i;
                new_src = gallery_data[i].certificateImage || "https://raw.githubusercontent.com/YassienTawfikk/assets/main/assets/images/placeholder.jpg";
                break;
            }
        }
    ...
    navigate_gallery: function (prev_clicks, next_clicks, gallery_data, current_index) {
        ...
        const new_src = gallery_data[new_index].certificateImage || "https://raw.githubusercontent.com/YassienTawfikk/assets/main/assets/images/placeholder.jpg";
