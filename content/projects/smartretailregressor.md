...
highlights:
- "Random Forest achieved 97.69% R\xB2 score, outperforming XGBoost."
- Extensive feature engineering including holiday distances, periodicity encoding,
  and store metadata.
