...
video_demo: https://github.com/user-attachments/assets/a13dae43-fa16-44d7-8f04-d47be1091a1d
tech_stack:
- Python
- PyQt / Tkinter
- Signal Processing
...
- Real-Time Playback
highlights:
- Multiple equalizer modes including uniform range, instrument-specific, vowel removal,
  and Wiener filter for noise reduction.
